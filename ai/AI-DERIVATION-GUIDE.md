...
| [panemar-morarit-si-panificatie-srl-nodejs-scraper](https://github.com/sebiboga/panemar-morarit-si-panificatie-srl-nodejs-scraper) | HTML/cheerio (CF7 `menu-117` select) | 4844886 (7 digits!) | Second 7-digit CIF — confirmed NO zero-padding: jobs/company store the real CIF, peviitor jobs query API still demands 8 digits (handled with a warning) | ✅ Live |
